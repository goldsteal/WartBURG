...
# `firmware' is a WartBURG action class (M1.3 UEFI-firmware-setup entry), not a
# distro -- it gets the chip glyph rather than a logo fetched by gen-icons.sh.
CLASSES=(artix garuda endeavouros manjaro t2 bedrock kali popos elementary mx
  ...
  lmde sparky q4os peppermint bodhi steamos1 steamos2 steamos3 firmware)
